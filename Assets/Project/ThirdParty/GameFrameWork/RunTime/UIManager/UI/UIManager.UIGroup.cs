...
namespace GameFramework
{
    internal sealed partial class UIManager : GameFrameworkModule, IUIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            private readonly UIGroupOpenMode m_OpenMode;
            ...
            /// <param name="openMode">打开策略。</param>
            public UIGroup(string name, int depth, IUIGroupHelper uiGroupHelper, UIGroupOpenMode openMode = UIGroupOpenMode.ClearToTop)
            {
            ...
            /// 获取界面组打开策略。
            /// </summary>
            public UIGroupOpenMode OpenMode
            {
                get
                {
                    return m_OpenMode;
            ...
            /// <summary>
            /// 收集位于目标界面之上的所有界面（不含目标本身，自上而下）。
            /// </summary>
            public void GetUIFormsAbove(IUIForm target, List<IUIForm> results)
            {
                if (results == null)
                {
                    throw new GameFrameworkException("Results is invalid.");
                ...
                while (current != null)
                {
                    if (current.Value.UIForm == target)
                    {
                        break;
                    }

                    results.Add(current.Value.UIForm);
