//------------------------------------------------------------
// ProcedureComponent Inspector (Refresh-aligned)
//------------------------------------------------------------
...
namespace GameFramework.Editor
{
    ...
    internal sealed class ProcedureComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                ProcedureBase current = t.CurrentProcedure;
                EditorGUILayout.LabelField("Current Procedure", current == null ? "None" : current.GetType().ToString());
            }
